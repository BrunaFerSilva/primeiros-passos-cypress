...
describe('Orange HRM Tests', () => {
  ...
  it.only('User Infor Update - Success', () => {
    ...
    cy.get(selectorsList.comboBoxSelection).eq(0).click({force: true})
    cy.get(selectorsList.selectText).click()
    cy.get(selectorsList.comboBoxSelection).eq(1).click({force: true})
    cy.get(selectorsList.selectText).click()
